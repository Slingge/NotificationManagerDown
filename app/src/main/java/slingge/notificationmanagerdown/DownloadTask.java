...
public class DownloadTask extends AsyncTask<String ,Integer,Integer>{
    ...
    public DownloadListenter listenter;
    ...
    protected Integer doInBackground(String... params) {
        ...
        try {
            long downloadedLength=0;//下载文件长度
            ...
            Request request=new Request.Builder().addHeader("RANGE","bytes="+downloadedLength+"-").url(downloadUrl).build();//断点下载，指定从哪个字节开始
